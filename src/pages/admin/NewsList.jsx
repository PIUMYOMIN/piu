          ...
          <tbody>
            {news.map((news) => (
              <tr key={news.id} className="text-sm">
                ...
                <td className="border border-gray-200 p-2">{news.author}</td>
                <td className="border border-gray-200 p-2">{news.category}</td>
                <td className="border border-gray-200 p-2">{news.date}</td>
                <td className="border border-gray-200 p-2">
                  <button
