        ...
        <div className="grid lg:grid-cols-2 my-10 bg-primary-background">
          <div className="py-5">
            ...
            <form className="w-full px-5 lg:mt-8 mx-auto" onSubmit={submitContactForm}>
              ...
              <button type="submit" className="text-white mt-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Submit
              </button>
            </form>
          </div>
