        ...
        <form className="max-w-6xl my-6" onSubmit={submitApplicationForm}>
              ...
              <div className="flex flex-wrap py-2">
                <div className="flex items-center me-4">
                  <input
                    ...
                    onChange={e => setaAlumni(e.target.value)}
                  />
                  <label
                    htmlFor="Yes"
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input
                className="block w-full py-3 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                id="profile"
                type="file"
