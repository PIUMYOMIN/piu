        ...
        <form className="max-w-6xl my-5 overflow-hidden" onSubmit={submitApplicationForm}>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${error.student_id ? "border-red-500" : "border-gray-200"} rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white`} id="grid-city" type="text" placeholder="Student ID" onChange={e => setStudentId(e.target.value)} />
              {error.student_id && <p className="text-red-500 text-xs italic">
                  {error.student_id}
                </p>}
            </div>
          </div>
