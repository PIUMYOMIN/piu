  ...
  return <div className="w-full bg-primary-background py-8 px-2">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-row justify-between items-center my-3">
          ...
          <Link to="#!" className="flex flex-row items-center hover:underline gap-2">
          ...
          {courses.map((course, index) =>
            ...
            >
              ...
              <div className="py-2">
                ...
                <Link
                  to={course.slug}
                  className="lg:text-xl block hover:underline my-2 transition duration-300 ease-in-out hover:text-orange-400"
                >
                  {course.title}
                </Link>
              </div>
