  ...
  return <div className="max-w-7xl mx-auto z-10 font-robotoSlab">
      <div className="lg:bg-green-700 text-white lg:py-2 lg:pl-3">
        <div className="lg:flex items-center justify-between lg:py-5">
          ...
          <ul className={`lg:flex lg:item:center lg:pb-0 pb-12 absolute lg:static lg:z-auto z-20 left-0 w-full lg:w-auto lg:pl-0 pl-5 transition-all duration-500 ease-in ${open ? "top-24 bg-green-700 text-white" : "top-[-490px]"} gap-8`}>
            ...
            <li className="relative lg:my-0 my-5" onMouseEnter={() => setAcademicHovered(true)} onMouseLeave={() => setAcademicHovered(false)}>
              ...
              <div className={`lg:absolute bg-green-700 w-48 
            ...
            <li className="relative lg:my-0 my-5" onMouseEnter={() => setNewsHovered(true)} onMouseLeave={() => setNewsHovered(false)}>
              ...
              <div className={`lg:absolute bg-green-700 w-48 ${newsHovered ? "block" : "hidden"} transition-all duration-500 ease-in lg:pt-3 z-10`} role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
                <ul className="px-2">
                  <li className="my-5 hover:text-gray-400" role="menuitem" tabIndex="-1" id="menu-item-0">
