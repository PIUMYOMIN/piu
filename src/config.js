// src/config.js
export const config = {
  // Base URL of the backend (no /api prefix). Example: https://backend.piueducation.org
  // For XAMPP Laravel, the typical local URL is: http://10.88.0.3/<project>/public
  apiBaseUrl:
    import.meta.env.VITE_API_BASE_URL || 'https://backend.piueducation.org',
  // Back-compat: some older code expects VITE_API_URL to include an API version path.
  apiUrl:
    import.meta.env.VITE_API_URL ||
    `${import.meta.env.VITE_API_BASE_URL || 'https://backend.piueducation.org'}/api/v1`,
