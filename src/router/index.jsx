...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "assignments/add", element: withSeo(<TeacherAssignmentForm />, privateSeo("Add Assignment")) },
      { path: "assignments/edit/:id", element: withSeo(<TeacherAssignmentForm />, privateSeo("Edit Assignment")) },
      ...
      { path: "students/:id/grades", element: withSeo(<TeacherStudentGrades />, privateSeo("Student Grades")) },
